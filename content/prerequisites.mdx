...
For that to work the node needs a **public IP and inbound 80 and 443**. Behind NAT with no
port-forward, generated hostnames cannot be issued certificates and you will need a domain with
DNS-01 instead.
...
Next: [Quickstart](/quickstart) · [Install the platform](/install) · [Why these choices](/why)
