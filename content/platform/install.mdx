...
<Callout type="warning">
**No component profile installs yet.** `observability` and `secrets` are pinned in the manifest
and marked provisional there, but neither is built. Stage 11 refuses
