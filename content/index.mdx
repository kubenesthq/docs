...
<Callout type="info">
**Day-2 operations is the product.** The bundle, its upgrades with rollback, its verified restore
drills and its OS patching are what kubenest is for.

The app layer — deploying multi-component applications without writing manifests — exists, is
supported, and is documented here. It is not the reason to buy.
</Callout>
