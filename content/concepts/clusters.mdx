...
```
pending  ← (record created; BYO clusters stay here until the operator connects)
  │
  ├──────────────────────┐
  │                      ▼
  │              provisioning  ← (cloud-provisioned only — VMs coming up)
  │                      │
  │                      ▼
  │              awaiting_operator  ← (cloud-provisioned only — infra ready,
